...
#ifndef BLUESWIFT_SWIFT_H
#define BLUESWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlueSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// Class implementing peripheral manager delegate. Manages advertisement state.
SWIFT_CLASS("_TtC9BlueSwift20AdvertisementService")
@interface AdvertisementService : NSObject
...
@interface AdvertisementService (SWIFT_EXTENSION(BlueSwift)) <CBPeripheralManagerDelegate>
/// seealso:
/// <code>CBPeripheralManagerDelegate</code>
...
SWIFT_CLASS("_TtC9BlueSwift19BluetoothConnection")
...
SWIFT_CLASS("_TtC9BlueSwift17ConnectionService")
...
@interface ConnectionService (SWIFT_EXTENSION(BlueSwift)) <CBPeripheralDelegate>
...
@interface ConnectionService (SWIFT_EXTENSION(BlueSwift)) <CBCentralManagerDelegate>
